						...
						<div class="tab-content">
							<div class="tab-pane fade in active" id="tab1">
								<table class="table table-hover">
									...
									<tbody>
									<?php foreach ($vegmenu as $veg) { ?>
										<tr>
											<td><?php echo $veg->m_name; ?></td>
											<td><?php echo $veg->m_price; ?></td>
											<td><?php echo $veg->m_type; ?></td>
											<td><?php echo $veg->m_subtype; ?></td>
											<td><?php echo $veg->m_category; ?></td>
											<td><?php echo $this->tag->linkTo(array('menu/edit/' . $veg->m_id, '<span class="glyphicon glyphicon-pencil"></span>', 'onclick' => 'return confirm("Do you want to proceed to edit this item?")')); ?>&nbsp;&nbsp;&nbsp;<?php echo $this->tag->linkTo(array('menu/delete/' . $veg->m_id, '<span class="glyphicon glyphicon-remove"></span>', 'onclick' => 'return confirm("Do you want to proceed to delete this item?")')); ?></td>
										</tr>
									<?php } ?>
									</tbody>
								</table>
