...
<body data-spy="scroll" data-target="#navbar" data-offset="120" >
    ...
    <div id="menu" class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div id="navbar" class="navbar-collapse collapse">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li><a href="http://localhost/rms/signup">Sign Up</a></li>

		<li><a href="http://localhost/rms/login">Sign In</a></li>
    ...
    <div id="header">
        ...
        <div class="center text-center">
            <div class="banner">
                <h1 class="">Food King</h1>
            </div>
            <div class="subtitle"><h4>AWESOME RESTAURANT WEBSITE</h4></div>
        </div>
                ...
                <div class="col-md-6 col-sm-6">
                    ...
                    <div class="pricing-item">
                        ...
                        <div class="pricing-item-details">
                            ...
                            <a class="btn btn-danger" href="http://localhost/rms/login">Order now</a>
