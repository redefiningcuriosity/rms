						...
						<form class="form-horizontal" action="http://localhost/rms/profile/update" method="post">
							<fieldset>
								...
								<div class="form-group">
									...
									<div class="col-md-9">
									<input id="fname" name="fname" value= "{{ user.u_fname }}" class="form-control" type="text">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-9">
									<input id="lname" name="lname" value= "{{ user.u_lname }}" class="form-control" type="text">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-9">
										<input id="email" name="email" value= "{{ user.u_email }}" class="form-control" type="text" readonly>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-9">
										<input id="phno" name="phno" value= "{{ user.u_phno }}" class="form-control" type="text">
									</div>
								</div>
